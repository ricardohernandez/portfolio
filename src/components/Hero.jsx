  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30 dark:bg-[url('data:image/svg+xml;base64,')] dark:opacity-15 animate-grid-float"></div>
      </div>
            ...
            <div className="w-full max-w-xl mx-0 flex justify-center">
              ...
              <div className="w-full flex items-center gap-2">
                {sliders.map((_, index) => (
                  <div
                    key={index}
                    className="flex-1 h-1 bg-gray-300 dark:bg-gray-700 rounded-full overflow-hidden cursor-pointer hover:h-1.5 transition-all duration-300"
                    onClick={() => {
                  ...
                  >
                    <div
                      className={`h-full bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full transition-all ${
                        index === sliderIndex ? 'animate-progress' : 'w-0'
                      }`}
                      style={{
                        animation: index === sliderIndex ? 'progress 20s linear forwards' : 'none',
                        width: index === sliderIndex ? '100%' : '0%'
                      }}
                    />
                  </div>
                ))}
